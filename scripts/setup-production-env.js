...
Object.entries(envVars).forEach(([key, value]) => {
  const displayValue = key.includes('SECRET') || key.includes('SERVICE_ROLE') || key.includes('DATABASE_URL')
...
console.log('   • NEXTAUTH_URL must be EXACTLY: https://e-learning-platform-beta.vercel.app');
